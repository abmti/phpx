 ...
 * <p>By default, the <code>rendererType</code> property must be set to "<code>php.faces.Button</code>".
 * This value can be changed by calling the <code>setRendererType()</code> method.</p>
 */
class HtmlCommandButton extends UICommand {


	public function __construct() {
        parent::__construct();
        $this->setRendererType("php.faces.Button");
    }
     ...
     */
    public static $COMPONENT_TYPE = "php.faces.HtmlCommandButton";
    ...
    public function getImage() {
        ...
        $_ve = $this->getValueExpression("image");
        if ($_ve != null) {
            return $_ve->getValue($this->getFacesContext()->getELContext());
        } else {
            return null;
