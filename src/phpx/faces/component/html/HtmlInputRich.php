 ...
 */
class HtmlInputRich extends UIInput {
     ...
     */
    public static $COMPONENT_TYPE = "php.faces.HtmlInputRich";
    ...
    public function getCols() {
        ...
        $_ve = $this->getValueExpression("cols");
        if ($_ve != null) {
            return $_ve->getValue($this->getFacesContext()->getELContext());
        } else {
            return 0;
    ...
    public function getRows() {
        ...
        $_ve = $this->getValueExpression("rows");
        if ($_ve != null) {
            return $_ve->getValue($this->getFacesContext()->getELContext());
        } else {
            return 0;
     ...
     * <p>Contents: Advisory type information about markup elements generated
     * for this component.
     */
