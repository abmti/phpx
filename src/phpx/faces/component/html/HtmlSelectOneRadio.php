...
use phpx\faces\component\UISelectOne;

/**
 * <p>Represents a single-selection component that is rendered
 * as a set of HTML <code>input</code> elements of type
 * <code>radio</code>.</p>
 * <p>By default, the <code>rendererType</code> property must be set to "<code>php.faces.Radio</code>".
 * This value can be changed by calling the <code>setRendererType()</code> method.</p>
 */
class HtmlSelectOneRadio extends UISelectOne {


	public function __construct() {
		parent::__construct();
		$this->setRendererType("php.faces.Radio");
	}
	 ...
	 */
	public static $COMPONENT_TYPE = "php.faces.HtmlSelectOneRadio";
	...
	public function getDisabledClass() {
		...
		$_ve = $this->getValueExpression("disabledClass");
		if ($_ve != null) {
			return $_ve->getValue($this->getFacesContext()->getELContext());
		} else {
			return null;
	...
	public function getEnabledClass() {
		...
		$_ve = $this->getValueExpression("enabledClass");
		if ($_ve != null) {
			return $_ve->getValue($this->getFacesContext()->getELContext());
		} else {
			return null;
	 ...
	 */
	public function setEnabledClass($enabledClass) {
