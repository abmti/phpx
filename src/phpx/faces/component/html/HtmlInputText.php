 ...
 * <p>By default, the <code>rendererType</code> property must be set to "<code>php.faces.Text</code>".
 * This value can be changed by calling the <code>setRendererType()</code> method.</p>
 */
class HtmlInputText extends UIInput {

	const COMPONENT_TYPE = "php.faces.HtmlInputText";
    ...
    public function setDisabled($disabled) {
        ...
        $this->handleAttribute("disabled", $disabled);
    }
    ...
    public function setReadOnly($readOnly) {
        ...
        $this->handleAttribute("readOnly", $readOnly);
    }
